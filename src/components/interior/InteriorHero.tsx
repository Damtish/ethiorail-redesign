...
export function InteriorHero({
  ...
  return (
    ...
    >
      ...
      <Container className="relative pt-[clamp(7rem,12vw,8rem)] pb-[clamp(2.5rem,6vw,4rem)] lg:pt-[clamp(8.25rem,9vw,9.25rem)] lg:pb-[clamp(3rem,4vw,4rem)]">
        <div className="mb-8 lg:mb-10">
          <Breadcrumbs items={breadcrumbs} dark={dark} />
        </div>
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,0.82fr)_minmax(24rem,1fr)] lg:gap-14">
